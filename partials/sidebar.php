<?php
// Default identity if none provided (useful for local development/XAMPP)
if (!isset($user)) {
    $user = [
        'name' => 'Engineer User',
...
<script>
    // Prevent sidebar flicker on page load — mirrors admin sidebar pattern
    (function() {
...
<style>
    /* Collapse state — applied instantly before paint to prevent flicker — Desktop Only */
    @media (min-width: 1025px) {
        html.sidebar-is-collapsed .sidebar { width: 88px !important; transition: none !important; }
        html.sidebar-is-collapsed .main-content { padding-left: 88px !important; transition: none !important; }
    ...
    <div class="sidebar-top no-scrollbar">
        <div class="brand-row">
            <div class="brand-icon-box logo-box">
                <img src="https://commons.wikimedia.org/wiki/Special:FilePath/Davao_de_Oro_Official_Seal.png"
        ...
        <div class="sidebar-label">ENGINEER CONSOLE</div>
        ...
        <nav class="sidebar-nav">
            ...
            <a href="MaintenanceProject.php" class="nav-item <?php echo ($current_page === 'maintenance_projects') ? 'active' : ''; ?>">
            ...
            <a href="MonthlyUpdates.php" class="nav-item <?php echo ($current_page === 'monthly_updates') ? 'active' : ''; ?>">
            ...
            <a href="Engineer.php" class="nav-item <?php echo ($current_page === 'engineers') ? 'active' : ''; ?>">
                ...
                <span class="nav-label">Engineers</span>
            </a>
            <a href="RoadSection.php" class="nav-item <?php echo ($current_page === 'roads') ? 'active' : ''; ?>">
            ...
            <a href="LGUs.php" class="nav-item <?php echo ($current_page === 'lgus') ? 'active' : ''; ?>">
                ...
                <span class="nav-label">LGUs</span>
            </a>
