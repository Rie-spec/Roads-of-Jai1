<?php 
// Settings Page - High Fidelity Integration
...
<head>
    ...
    <title>JAIROADS — Account Settings</title>
...
<main id="mainContent" class="main-content profiles-page">
    <header class="top-nav-bar">
        ...
        <div class="header-title-section">
            <h1 class="page-title" id="pageTitle">Account Profile</h1>
            <div class="page-subtitle" id="pageSubtitle">Manage your personal information and history</div>
        </div>
    ...
    <div class="page-container">
        <div class="main-tabs">
            <button class="main-tab-btn active" id="tabBtnProfile" onclick="switchTab('profile',this)">Account Profile</button>
          ...
          <div class="settings-profile-body">
            <div class="settings-avatar-wrap">
              <div class="settings-avatar" id="profileAvatar" onclick="triggerAvatarUpload()">
                <span id="profileAvatarText">JJ</span>
            ...
            <div class="profile-view" id="profileViewMode">
              ...
              <div style="display:flex;justify-content:center">
                <div class="profile-role-badge">
                  ...
                  <span id="profileRole">Engineer</span>
                </div>
              </div>
            ...
            <div class="profile-edit" id="profileEditMode">
              ...
              <div class="edit-inline-field">
                ...
                <input type="text" id="editRole" placeholder="e.g. Lead Engineer">
              </div>
