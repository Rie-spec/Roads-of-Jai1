...
<body class="no-scrollbar">
    ...
    <main id="mainContent" class="main-content lgus-page">
        <header class="top-nav-bar">
            ...
            <div class="global-actions">
                ...
                <button id="newLGUBtn" class="btn-quick-add">
    ...
    <!-- Modals & Panels -->
    <?php include __DIR__ . '/../components/modal/AdminLGUDetails.php'; ?>
    <?php include __DIR__ . '/../components/forms/AdminLGUForms.php'; ?>
    ...
    <div class="modal-overlay" id="deleteConfirmModal" style="display: none;">
        <div class="modal-box" style="width: 400px; background: #fff; border-radius: 24px; padding: 32px; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.25);">
            <div style="margin-bottom: 24px; text-align: center;">
                ...
                <h3 style="color: #ef4444; font-size: 20px; font-weight: 800; margin-bottom: 8px;">Delete LGU Record?</h3>
