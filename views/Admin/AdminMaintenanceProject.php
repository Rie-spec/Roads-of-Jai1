...
<head>
    ...
    <title>Admin - Maintenance Projects | JAIROADS</title>
        ...
        <header class="top-nav-bar">
            <button class="mobile-menu-btn" id="mobileMenuBtn">
                ...
                <div class="header-title-section">
                    <h1>Maintenance Projects (Admin)</h1>
                </div>
...
<div id="notifBackdrop" class="notif-backdrop"></div>
    <div id="notifPanel" class="notif-panel">
        ...
        <div class="notif-footer">
            <a class="notif-footer-link" href="AdminActivityLog.php">View All in Activity Log</a>
        </div>
    </div>
    <!-- END OF ADDED BLOCK -->

    <?php include __DIR__ . '/../components/modal/AdminMPDetails.php'; ?>
    <?php include __DIR__ . '/../components/forms/AdminMPForms.php'; ?>

    <script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"></script>
    <!-- ADD THESE TWO LINES before the module script: -->
